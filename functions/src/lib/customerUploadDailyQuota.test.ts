...
import { quotaExhaustedMessage, resolveDailyQuotaTarget } from "./customerUploadDailyQuota";

describe("resolveDailyQuotaTarget", () => {
  it("keeps legacy print-request field names and limits", () => {
  ...
  it("uses separate donation fields and higher limits", () => {
...
describe("quotaExhaustedMessage", () => {
  ...
  it("mentions uploaded designs for print-request purpose", () => {
    const message = quotaExhaustedMessage("finalizeImage", 200, "print_request");
