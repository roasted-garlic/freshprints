/**
 * Cross-environment SHA-256 (hex). Used for deterministic preview checksums in browser + Node.
 * Avoids node:crypto so shared recovery helpers load in Studio/Vite.
 */
