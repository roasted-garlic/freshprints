...
/**
 * {{excluded_tags}} and {{approved_categories}} are required in the shipped v34 prompt.
 * {{approved_categories}} injects active category name + owner description (whitespace-collapsed).
