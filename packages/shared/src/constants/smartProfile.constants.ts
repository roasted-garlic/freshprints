...
export const SMART_PROFILE_NORMALIZER_VERSION = "smart-profile-normalizer-v4";
...
export const CURRENT_CATALOG_ENRICH_PROMPT_VERSION = "catalog-enrich-v30" as const;
