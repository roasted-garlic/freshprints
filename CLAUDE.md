# AI Agents — FreshForge Entry Point (Claude)

> **Read this file first** when using **Claude** (Claude Code, Claude Projects, or Claude in Cursor) on a repository with the **FreshForge** workflow starter.
...
| File | Use with |
|------|----------|
| **`CLAUDE.md`** (this file) | Claude Code, Claude Projects, Claude in Cursor |
| **`AGENTS.md`** | Cursor default agents, other AI tools |

Content is equivalent; both point to the same FreshForge workflow and docs.
...
|------|----------|----------------------------|
| **Starter Surface** | `AGENTS.md`, `CLAUDE.md`, `.cursor/`, `docs/` (not `docs/freshforge-development/`) | **Yes** |
