...
/** Customer-facing message when ADR-FP-115 tombstone blocks Portal sign-in. */
export const PORTAL_ACCOUNT_CLOSED_MESSAGE =
  'This account has been closed. Please contact Fresh Prints if you need help.';
