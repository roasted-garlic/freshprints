...
interface StandardPrintSizesModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function StandardPrintSizesModal({
  ...
  return (
    <div className="modal-overlay modal-overlay-blur" onClick={onClose} role="presentation">
      <Modal
        aria-labelledby="standard-print-sizes-modal-title"
        aria-modal="true"
        className="standard-print-sizes-modal"
        onClick={(event) => event.stopPropagation()}
        role="dialog"
      >
        <ModalHeader className="standard-print-sizes-modal-header">
          <h2 id="standard-print-sizes-modal-title">Standard Sizes</h2>
          <button
            aria-label="Close"
        ...
        <ModalBody className="standard-print-sizes-modal-body">
