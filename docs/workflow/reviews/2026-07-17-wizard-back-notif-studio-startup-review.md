...
2. **Unread acks** — new collection `assistedCreationUpdateAcks`; do not overload `staffInboxAcks`. Mark read on History expand using latest customer-update timestamp as `readThroughAt`.
