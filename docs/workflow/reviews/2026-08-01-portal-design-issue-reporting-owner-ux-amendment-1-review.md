...
- Keep Report an Issue alone at the left and Background, Share, and Favorite grouped in that order at the right on the same design-details toolbar row.
...
- DOM order remains logical for keyboard navigation: Report, Background, Share, Favorite, then Add to request.
