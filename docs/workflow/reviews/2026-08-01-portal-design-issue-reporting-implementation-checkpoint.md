...
- The design-details action bar now keeps Report an Issue alone on the left and Background, Share, and Favorite grouped in that order on the right with the established spacing, all on one row.
