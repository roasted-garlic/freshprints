...
| TD-027 | Fresh Prints Assisted Creation deferred after Phase 9A | feature gap | medium | Portal Custom Designs cards | Coming-soon card only in 9A | Separate managed phase | `phase-9c-assisted-creation` | open |
