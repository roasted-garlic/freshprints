...
| 13 | `production-release` — prod Firebase / App Hosting / Google / email | **Active** — bundled brand visual QA **PASS** on `development`; await Studio installer / Portal App Hosting branding release phrases. Registration unblocked; Stage 1 + Class D closed. |
...
**Active managed goal:** `production-release` (Goal #13) — bundled brand visual QA **PASS**.
Next: `APPROVE PRODUCTION STUDIO INSTALLER: BUNDLED BRAND ASSETS` and/or
`APPROVE PRODUCTION PORTAL APP HOSTING ROLLOUT: BUNDLED BRAND ASSETS`. Stage 2 after branding
production releases (or owner resequences).
