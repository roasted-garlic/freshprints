...
| 13 | `production-release` — prod Firebase / App Hosting / Google / email | **Active** — bundled brand **on development** (await visual QA + Studio/Portal release approvals). Registration unblocked. Stage 1 complete; Class D closed. |
...
**Active managed goal:** `production-release` (Goal #13) — bundled brand assets implemented on
`development`. Next: owner visual QA, then separate Studio installer / Portal App Hosting branding
rollout approvals. Stage 2 after branding release path.
