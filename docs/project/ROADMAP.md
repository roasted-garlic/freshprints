...
| 13 | `production-release` — prod Firebase / App Hosting / Google / email | **Active** — Stage 2 paused. Assisted library design search **signed off** (QA PASS). Tag-removal/resize/branding/registration signed off. Domain deferred. Stage 1 + Class D closed. |
