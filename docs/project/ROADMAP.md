...
| 13 | `production-release` — prod Firebase / App Hosting / Google / email | **Active** — Class D Storage↔Firestore cross-service IAM **applied** (`firebaserules.firestoreServiceAgent` → Storage SA). Owner Studio upload QA pending. Brand mapping approved; asset implement gated. Stage 2 not started. |
