...
| 13 | `production-release` — prod Firebase / App Hosting / Google / email | **Active** — Class D Storage closed (IAM + owner QA **PASS WITH NOTES**). Stage 1B/1C fixtures next; Stage 2 not started. Brand mapping approved; asset implement gated. |
...
**Active managed goal:** `production-release` (Goal #13) — Storage Class D **closed**
(2026-07-31 owner **PASS WITH NOTES**). Domain-last sequencing still approved. Next: Stage 1B
upcoming show + Stage 1C catalog design fixtures → Stage 2 hosted.app smoke → Stage 3 gate →
Stage 4 domain. Brand asset replacement still gated on
`APPROVE BUNDLED BRAND ASSET IMPLEMENTATION`. See
`docs/workflow/reviews/2026-07-31-production-storage-cross-service-permission-checkpoint.md`
and Stage 1 checkpoint.
